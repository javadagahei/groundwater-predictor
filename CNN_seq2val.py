...
def load_RM_GW_and_HYRAS_Data(i):
    pathGW = "D:\data\DATA\GWData\آباده طشک-جهان آباد"
    pathHYRAS = "D:\data\DATA\MeteoData\آباده طشک-جهان آباد"
    pathconnect = "/"
...
with tf.device("/cpu:0"):
    ...
    basedir = 'D:\data\تشک بختگان\آباده طشک-جهان آباد\خروجی\CNN\seq2val'
    os.chdir(basedir)
